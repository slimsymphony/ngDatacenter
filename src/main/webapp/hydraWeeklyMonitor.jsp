				...
				for(Element ele2 : els) {
					if("release-state".equalsIgnoreCase(ele2.element( "name" ).getStringValue())) {
						if("Ready".equalsIgnoreCase(ele2.element( "value" ).getStringValue())) {
							...
							CommonUtils.invokeRemote("http://becim019.rnd.nokia.com:8080/job/Hydra-weekly-release-getter-ng14-pegasus/build?delay=0sec");
							CommonUtils.invokeRemote("http://becim019.rnd.nokia.com:8080/job/Hydra-weekly-release-getter-pegasusDS/build?delay=0sec");
						}else {
